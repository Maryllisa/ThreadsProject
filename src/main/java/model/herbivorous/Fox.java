...
//лиса
public class Fox extends Herbivorous implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    //0	0	-	0	0	0	0	70	90	0	0	0	0	60	40	0
    private final double[] probability = new double[]{0,0,0,0,0,0,0,0.70,0.90,0,0,0,0,0.60,0.40,0};
    private int speed;
    ...
    public Fox(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Fox(float wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
