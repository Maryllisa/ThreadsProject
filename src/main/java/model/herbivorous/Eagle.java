...
//Орел
public class Eagle extends Herbivorous implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    //0	0	10	0	-	0	0	90	90	0	0	0	0	80	0	0
    private final double[] probability = new double[]{0,0,0.10,0,0,0,0,0.90,0.90,0,0,0,0,0.80,0,0};
    private int speed;
    ...
    public Eagle(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Eagle(float wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
