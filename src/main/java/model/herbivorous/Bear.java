...
//медведь
public class Bear extends Herbivorous implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    ...
    public Bear(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Bear(float wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
