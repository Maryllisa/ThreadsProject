...
//удав
public class Boa extends Herbivorous implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    //0	-	15	0	0	0	0	20	40	0	0	0	0	10	0	0
    private final double[] probability = new double[]{0,0,0.15,0,0,0,0,0.20,0.40,0,0,0,0,0.10,0,0};
    private int speed;
    ...
    public Boa(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Boa(float wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
