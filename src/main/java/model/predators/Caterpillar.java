...
//гусеница
public class Caterpillar extends Predator implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    ...
    public Caterpillar(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Caterpillar(double wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
