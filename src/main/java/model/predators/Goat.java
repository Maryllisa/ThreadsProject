...
//коза
public class Goat extends Predator implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    ...
    public Goat(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Goat(double wight, int speed, double foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
