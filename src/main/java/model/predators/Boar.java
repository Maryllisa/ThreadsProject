...
//кабан
public class Boar extends Predator implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    //0	0	0	0	0	0	0	0	50	0	0	-	0	0	90	100
    private final double[] probability
            = new double[]{0,0,0,0,0,0,0,0,0.50,0,0,0,0,0,0.90,1};
    private int speed;
    ...
    public Boar(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Boar(double wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
