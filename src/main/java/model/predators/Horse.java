...
//лошадь
public class Horse extends Predator implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    ...
    public Horse(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Horse(double wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
