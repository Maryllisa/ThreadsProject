...
//Олень
public class Deer extends Predator implements Callable<Printer> {
    private int HP;
    private int x;
    private int y;
    ...
    public Deer(Printer printer,List<String> whoIs, int sizeX, int sizeY) {
    ...
    public Deer(float wight, int speed, float foodMuch, int x, int y, int sizeX, int sizeY){
        this.wight = wight;
        this.speed =speed;
